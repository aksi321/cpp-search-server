...
public:
    ...
    void AddDocument(int document_id, const string& document) {
        ...
        for (const string& word : words) {
            word_to_documents_freqs_[word][document_id] += one_TF;
        }
    }
...
private:
    ...
    vector<Document> FindAllDocuments(const Query& query_words) const {
        ...
        for (const auto& word : query_words.plus_words) {
            ...
            for (const auto& [document_id, term_freq] : word_to_documents_freqs_.at(word)) {
        ...
        for (const string& word : query_words.minus_words) {
            ...
            for (const auto& [document_id, _] : word_to_documents_freqs_.at(word)) {
